...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/01/06 11:37:14 by aamzil            #+#    #+#             */
/*   Updated: 2021/01/06 11:37:16 by aamzil           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	treat_backslash(char **line, t_arg_manip *vars)
{
	if (vars->quote != '\'' &&
		(*line)[vars->i] == '\\' &&
		(*line)[vars->i + 1] == '\\')
