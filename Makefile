...
SRC= 	check_syntax.c													\
		...
		builtins/functions/helper_function/export_sort_env.c			\
		builtins/functions/helper_function/export_print_single_var.c	\
		...
		line_parser/helper_functions/fork_it.c							\
